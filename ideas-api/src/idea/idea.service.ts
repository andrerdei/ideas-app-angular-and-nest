...
export class IdeaService {
  ...
  public async create(data: IdeaDTO): Promise<IdeaDTO> {
  ...
  public async update(id: string, data: Partial<IdeaDTO>): Promise<IdeaDTO> {
  ...
  public async delete(id: string): Promise<IdeaDTO> {
    const idea = await this.ideaRepository.findOne({ where: { id } });
